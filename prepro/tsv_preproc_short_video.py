...
json_path = "./datasets/ShortVideo/MSRVTT_data.json"
val_csv_path = "./datasets/ShortVideo/origin/dev.csv"
test_csv = "./datasets/ShortVideo/MSRVTT_JSFUSION_test.csv"

# To generate tsv files:
# {}.img.tsv: we use it to store video path info 
visual_file = "./datasets/ShortVideo/{}.img.tsv"
# {}.caption.tsv: we use it to store  captions
cap_file = "./datasets/ShortVideo/{}.caption.tsv"
...
linelist_file = "./datasets/ShortVideo/{}.linelist.tsv"
...
label_file = "./datasets/ShortVideo/{}.label.tsv"
...
def process(split_type):
    ...
    gt_data = json.load(open(json_path, 'r', encoding='utf-8'))
    ...
    train_len = int(video_num * 0.8)
    val_len = int(video_num * 0.1)
    test_len = video_num - train_len - val_len
    split_dict = {"train": video_ids[:train_len], "val": video_ids[train_len:train_len + val_len], "test": video_ids[-test_len: video_num]}
